...
describe User do
  ...
  before do
    @user = User.new(name: "Officer", email: "officer@spectre.com",
                            password: "spectre",
  ...
  describe "email address with mixed case" do
    let(:mixed_case_email) { "OfFiCer@SpecTRe.CoM" }
  ...
  describe "action associations" do
    ...
    it "should list the right actions in the right order" do
      @user.actions.should == [newer_action, older_action]
    end
  end
end
